...
**YOU ARE IN: `todo/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/todo/` (rig root) or other directories
...
**Your mail address:** `todo/polecats/obsidian`
**Your rig:** todo
**Your Witness:** `todo/witness`
...
| Ask Witness for help | `gt mail send todo/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`todo/witness`) when:
...
```bash
gt mail send todo/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
